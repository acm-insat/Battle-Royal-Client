...
const Register = () => {
  ...
  const [inputList, setInputList] = React.useState([{ fullname: "", emailaddress: "", phonenumber: "", acmmember: false }]);
  ...
  const handleAddClick = () => {
    setInputList([...inputList, { fullname: "", emailaddress: "", phonenumber: "", acmmember: false }]);
  };
        ...
        return (
          <div className="box">
            ...
            <div className="box-subtitle">
              <input id={"acmmember"+(i+1)} type="checkbox" name="acmmember" onChange={e => handleCBChange(e, i)} value={x.acmmember}/><label for={"acmmember"+(i+1)}> ACM Member</label>
            </div>
            </div>
            <div className="p-1">
            ...
            {inputList.length !== 1 && <button
              className="mr10"
              onClick={() => handleRemoveClick(i)}><FontAwesomeIcon icon={faUserMinus} /></button>}
            {(inputList.length - 1 === i && inputList.length < 3) && <button onClick={handleAddClick}><FontAwesomeIcon icon={faUserPlus} /></button>}
          </div>
          <br/>
          </div>
          );
